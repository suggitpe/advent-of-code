...
import org.suggs.adventofcode.Day11CosmicExpansion.expand
...
class Day11CosmicExpansionTest {
    ...
    fun `calculates distances between coordinates`() {
        GalaxyRoute(Coordinate(0,0), Coordinate(1, 1)).distance() shouldBe 2
        GalaxyRoute(Coordinate(1,1), Coordinate(0, 0)).distance() shouldBe 2
        GalaxyRoute(Coordinate(1,6), Coordinate(5, 11)).distance() shouldBe 9
        GalaxyRoute(Coordinate(6,1), Coordinate(11, 5)).distance() shouldBe 9
    }
