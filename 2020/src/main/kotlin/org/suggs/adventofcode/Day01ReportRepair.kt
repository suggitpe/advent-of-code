...
class Day01ReportRepair {
    ...
    fun findTwoNumbersAndTimesThemFrom(listOfInts: List<Int>): Int {
        ...
        fun findAndMultiplyTwoFrom(head: Int, tail: List<Int>): Int {
    ...
    fun findThreeNumbersAndTimesThemFrom(listOfInts: List<Int>): Int {
        ...
        fun findAndMultiplyThreeFrom(head: Int, headToo: Int, tail: List<Int>): Int {
            if (tail.isEmpty()) return 0
        ...
        fun findThreeNumbersAndTimesThemFrom(head: Int, headToo: Int, tail: List<Int>): Int {
